...
const LEVELS = [
...

  {
    ...
    validate(doc, code) {
      ...
      return code.includes('<input') && code.includes('placeholder="Enter your name"') &&
             el?.getAttribute('placeholder') === 'Enter your name';
    }
  },
...

  {
    ...
    validate(doc, code) {
      ...
      return header && main && footer && h1?.textContent.trim() &&
             p?.textContent.trim() && footer.textContent.trim();
    }
  },

  {
    id: 14, xp: 300, badge: '🎯', chapter: 'Advanced', title: 'Attributes & Classes',
    lesson: '<p><strong>Attributes</strong> give elements extra info:</p><p><span class="code-inline">href</span>, <span class="code-inline">src</span>, <span class="code-inline">alt</span>, <span class="code-inline">placeholder</span>, etc.</p><p>The <span class="code-inline">class</span> attribute is special — it marks elements for CSS styling (grouping).</p><p>Example: <span class="code-inline">&lt;p class="intro"&gt;Welcome!&lt;/p&gt;</span></p>',
    ...
    validate(doc, code) {
      ...
      return code.includes('class="intro"') && code.includes('<p') &&
