...
/**
 * Level definitions for CodeQuest — HTML track.
 * Each level has:
 *   id, xp, badge, chapter, title, description (HTML string),
 *   tip, hint (HTML-escaped code), startCode, validate(doc)
 *
 * validate() receives the result of DOMParser.parseFromString(userCode, 'text/html')
 * and returns true when the level condition is met.
 */
...
const LEVELS = [
  {
    ...
    tip: 'Headings go from h1 (biggest) to h6 (smallest). The text inside must match exactly.',
    hint: '&lt;h1&gt;Hello, World!&lt;/h1&gt;',
    startCode: '',
    validate(doc) {
      const el = doc.querySelector('h1');
      return el !== null && el.textContent.trim() === 'Hello, World!';
    }
  },
...

  {
    ...
    validate(doc) {
      ...
      return el !== null && el.textContent.trim() === 'Important';
    }
  },

  {
    ...
    validate(doc) {
      ...
      return (
        ...
        el.getAttribute('href') === 'https://google.com'
      );
    }
  },

  {
    ...
    validate(doc) {
      ...
      return el !== null && src !== null && src.trim().length > 0;
    }
  },
...

  {
    ...
    validate(doc) {
      ...
      return el !== null && el.textContent.trim() === 'Click Me!';
    }
  },

  {
    ...
    validate(doc) {
      ...
      return el !== null && el.getAttribute('placeholder') === 'Enter your name';
    }
  },
