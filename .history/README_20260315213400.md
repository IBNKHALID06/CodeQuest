...
### Landing Page
![CodeQuest Landing Page](https://imgur.com/uploaded-image-url-here.png)

*Your game shows:*
- CodeQuest title with neon glow effect
- Player stats (XP, levels completed, streak)
- Language selection (HTML unlocked, CSS/JS/Python coming soon)
- "How It Works" visual guide

[To add the screenshot to GitHub: Upload to the repo's screenshots section or use Imgur, then replace the URL above]
